...
export default function profile() {
    ...
    async function handleLogout() {
        ...
        console.log('User logged out - reload app to see login screen')
        Alert.alert(
            'Logged Out',
            'You have been logged out. Please reload the app (Cmd+R) to return to login.',
            [{ text: 'OK' }]
        )
    }
  ...
  return userData ? (
    <ScrollView className='flex-1 bg-white' showsVerticalScrollIndicator={false}>
      ...
      <View className='border-t-[1px] border-gray-300 mt-10'>
        ...
        <Pressable onPress={handleLogout} className='px-6 flex flex-row h-20 items-center gap-4'>
