...
--
-- Host: localhost    Database: coopcounter
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=14746 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `notificationsType`
--
...
CREATE TABLE `notificationsType` (
  ...
  `type` varchar(20) NOT NULL,
  KEY `typeId` (`typeId`),
  CONSTRAINT `notificationsType_ibfk_1` FOREIGN KEY (`typeId`) REFERENCES `notifications` (`notificationId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  UNIQUE KEY `cameraId_2` (`cameraId`),
...
-- Dump completed on 2025-11-06  3:11:02
